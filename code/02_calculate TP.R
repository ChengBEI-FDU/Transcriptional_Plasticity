...
#### Input data ####
unfiltered_rpkm_mtb <- read.csv("./data/tmp data/unfiltered tmm rpkm Mtb.csv", row.names = 1)
unfiltered_rpkm_msm <- read.csv("./data/tmp data/unfiltered tmm rpkm Msm.csv", row.names = 1)
unfiltered_rpkm_mab <- read.csv("./data/tmp data/unfiltered tmm rpkm Mab.csv", row.names = 1)
...
final_sample_Mtb <- ZeroGeneCount_Mtb$Run[ZeroGeneCount_Mtb$ZeroGeneCount < Threshold_ZeroGene_per*4008]
final_sample_Msmeg <- ZeroGeneCount_Msmeg$Run[ZeroGeneCount_Msmeg$ZeroGeneCount < Threshold_ZeroGene_per*6884]
final_sample_Mab <- ZeroGeneCount_Mab$Run[ZeroGeneCount_Mab$ZeroGeneCount < Threshold_ZeroGene_per*4942]
